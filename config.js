...
const baseConfig = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'ΆR͢JͥUNͣNͫΝ<3 🦭🪻;default',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.NOT_ALLOWED || '852',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "🕊️⃟𝐌ʙᩢ𐡉𝐒͢ᴛ̏ᴀʀ̷ʙ͜͡ᴏ᪾𐡯",
    BOT_NAME: process.env.BOT_NAME || 'ᝃ𑁍 /  𝛿𝜯𝜶𐑾𝜝𝝄𝛾  ꭗ𝝐𐑾 ☇🧃㐪',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ᴡhois.Sтᴀʀʙᴏʏ<3;₉₀ᷤ₆ͭ₁ͣ₈ᷢ₀₁ⷡ₄ͦ₀ⷱ₈乡,https://telegra.ph/file/c1796557a792cd6f400e7.jpg' : process.env.AUDIO_DATA,
